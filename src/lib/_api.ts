...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  report = {
     ...
     * @request GET:/report/getCurrentReport
     */
    getCurrentReport: (params: RequestParams = {}) =>
      this.request<FinancialReport, void>({
     ...
     * @request POST:/report/moveTransaction
     */
    moveTransaction: (
      data: {
